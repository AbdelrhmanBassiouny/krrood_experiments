...
from ripple_down_rules.helpers import update_case_and_conclusions_with_rule_output
...
def classify(case: Dict, **kwargs) -> Set[type]:
    ...
    if conditions_20100493747705403503239541007013585584(case):
        update_case_and_conclusions_with_rule_output(
            case,
            conclusions,
            conclusion_20100493747705403503239541007013585584(case),
            attribute_name,
            conclusion_type,
            mutually_exclusive,
        )
    ...
    if conditions_178686770575922948619403589971234626498(case):
        update_case_and_conclusions_with_rule_output(
            case,
            conclusions,
            conclusion_178686770575922948619403589971234626498(case),
            attribute_name,
            conclusion_type,
            mutually_exclusive,
        )
    ...
    if conditions_39422379577793614665216170177046282573(case):
        update_case_and_conclusions_with_rule_output(
            case,
            conclusions,
            conclusion_39422379577793614665216170177046282573(case),
            attribute_name,
            conclusion_type,
            mutually_exclusive,
        )
