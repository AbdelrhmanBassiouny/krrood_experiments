...
from typing_extensions import Dict, List, Set, Union, Generic
...
from krrood_experiments.owl_instances_loader import OwlLoader
from krrood.class_diagrams.utils import nearest_common_ancestor
from abc import ABC
...
def conclusion_199871154586794138198665296345684269309(case) -> List[type]:
    def owl_loader_infer_most_appropriate_types_for_anonymous_instance(
        ...
        # if ancestor in [ABC, object, Generic]:
        # if ancestor and len(ranges) > 1:
        #     import pdbpp
        #
        #     pdbpp.set_trace()
        return ancestor
