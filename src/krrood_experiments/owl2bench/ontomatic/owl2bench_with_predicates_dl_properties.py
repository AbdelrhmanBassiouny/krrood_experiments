...
@dataclass(eq=False)
class Advises(PropertyDescriptor, HasEquivalentProperties):
    """Advises"""
...
@dataclass(eq=False)
class HasCollaborationWith(PropertyDescriptor, SymmetricProperty):
...
@dataclass(eq=False)
class IsAdvisedBy(PropertyDescriptor, HasInverseProperty, HasEquivalentProperties, IrreflexiveProperty):
    """IsAdvisedBy"""

    @classmethod
    def get_inverse(cls) -> Optional[Type[IsAdvisorOf]]:
...
@dataclass(eq=False)
class IsAdvisorOf(PropertyDescriptor, HasInverseProperty, HasEquivalentProperties):
    """IsAdvisorOf"""

    @classmethod
    def get_inverse(cls) -> Optional[Type[IsAdvisedBy]]:
        if cls is IsAdvisorOf:
            return IsAdvisedBy
        return None
...
@dataclass(eq=False)
class Knows(PropertyDescriptor, ReflexiveProperty):
    """Knows"""


@dataclass(eq=False)
class Likes(PropertyDescriptor, HasDisjointProperties):
    """Likes"""
