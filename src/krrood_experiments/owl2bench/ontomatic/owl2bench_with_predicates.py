    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (
            ...
            exists(
                candidate_var,
                IsSubClassOrRole(
                    variable_from(candidate_var.works_for.types), Employee
                ),
            ),
        )
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (
            ...
            exists(
                candidate_var,
                IsSubClassOrRole(
                    variable_from(candidate_var.is_head_of.types), Director
                ),
            ),
        )
...
class College(Organization):
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (
            ...
            exists(
                candidate_var,
                IsSubClassOrRole(variable_from(candidate_var.is_head_of.types), Dean),
            ),
        )
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (
            ...
            exists(
                candidate_var,
                IsSubClassOrRole(
                    variable_from(candidate_var.teaches_course.types), Faculty
                ),
            ),
        )
...
class Department(Organization):
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (
            ...
            exists(
                candidate_var,
                IsSubClassOrRole(variable_from(candidate_var.is_head_of.types), Chair),
            ),
        )
...
class PeopleWithHobby(Role[Person], Symbol):
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (
            exists(
                candidate_var,
                IsSubClassOrRole(variable_from(candidate_var.types), Person),
            ),
...
class SportsLover(Role[Person], Symbol):
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (
            ...
            exists(
                candidate_var,
                IsSubClassOrRole(variable_from(candidate_var.loves.types), Sports),
            ),
        )
...
class T20CricketFan(Role[Person], Symbol):
    ...
    @classmethod
    def axiom_python(cls, candidate: AnonymousClass) -> bool:
        return hasattr(candidate, "is_crazy_about") and (
            "http://benchmark/OWL2Bench#T20Cricket"
...
class LeisureStudent(Role[Student], Symbol):
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (
            exists(
                candidate_var,
                IsSubClassOrRole(variable_from(candidate_var.types), Student),
            ),
            HasAttribute(candidate_var, "takes_course"),
            # exists(candidate_var, IsSubClassOrRole(variable_from(candidate_var.takes_course.types), Course)),
            count(
                IsSubClassOrRole(
    ...
    def axiom_python(cls, candidate: AnonymousClass) -> bool:
        return (
            ...
            and hasattr(candidate, "takes_course")
            and (
                len(
                    [
                        v
                        for v in candidate.takes_course
                        if any(issubclass(t, Course) for t in v.types)
                    ]
                )
                <= 1
            )
...
class WomanCollege(College):
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (
            exists(
                candidate_var,
                IsSubClassOrRole(variable_from(candidate_var.types), College),
            ),
    ...
    def axiom_python(cls, candidate: AnonymousClass) -> bool:
        return (
            ...
            and hasattr(candidate, "has_student")
            and all(
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (
            ...
            exists(
                candidate_var,
                IsSubClassOrRole(
                    variable_from(candidate_var.is_head_of.types), College
                ),
            ),
        )
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (
            ...
            exists(
                candidate_var,
                IsSubClassOrRole(
                    variable_from(candidate_var.is_head_of.types), Program
                ),
            ),
        )
