...
class Person(OWL2BenchThing):
    ...
    dislikes: Set[OWL2BenchThing] = field(kw_only=True, default_factory=set)
    has_advisor: Set[Person] = field(kw_only=True, default_factory=set)
    ...
    has_major: Set[Union[Engineering, FineArts, HumanitiesAndSocialScience, Management, Science]] = field(kw_only=True, default_factory=set)
    has_master_degree_from: Set[University] = field(kw_only=True, default_factory=set)
    has_same_home_town_with: Set[Person] = field(kw_only=True, default_factory=set)
    ...
    is_advised_by: Set[Person] = field(kw_only=True, default_factory=set)
    is_advisor_of: Set[Person] = field(kw_only=True, default_factory=set)
    is_crazy_about: Set[OWL2BenchThing] = field(kw_only=True, default_factory=set)
    ...
    likes: Set[OWL2BenchThing] = field(kw_only=True, default_factory=set)
    loves: Set[OWL2BenchThing] = field(kw_only=True, default_factory=set)
...
class HumanitiesAndSocialScience(CollegeDiscipline):
    cls_uri: ClassVar[str] = "http://benchmark/OWL2Bench#HumanitiesAndSocialScience"
...
class NonScience(CollegeDiscipline):
    cls_uri: ClassVar[str] = "http://benchmark/OWL2Bench#NonScience"
...
class PGStudent(Student):
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (exists(IsSubClassOrRole(variable_from(candidate_var.types), Student)),
				...
				count(IsSubClassOrRole(variable_from(candidate_var.enroll_for.types), PGProgram)) == 1
        )
...
class PeopleWithManyHobbies(PeopleWithHobby):
    ...
    @classmethod
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        super_axiom, candidate_var = get_super_axiom_and_candidate_var(PeopleWithManyHobbies, cls, candidate)
        
        return (exists(IsSubClassOrRole(variable_from(candidate_var.types), Person)),
				HasProperty(candidate_var, Likes),
				count(IsSubClassOrRole(variable_from(candidate_var.likes.types), Interest)) >= 3
        )
...
class PhDStudent(Student):
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (exists(IsSubClassOrRole(variable_from(candidate_var.types), Student)),
				HasProperty(candidate_var, EnrollFor),
				count(IsSubClassOrRole(variable_from(candidate_var.enroll_for.types), PhDProgram)) == 1
        )
...
@dataclass(eq=False)
class Soccer(Sports):
    cls_uri: ClassVar[str] = "http://benchmark/OWL2Bench#Soccer"
...
class UGStudent(Student):
    ...
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        ...
        return (exists(IsSubClassOrRole(variable_from(candidate_var.types), Student)),
				HasProperty(candidate_var, EnrollFor),
				count(IsSubClassOrRole(variable_from(candidate_var.enroll_for.types), UGProgram)) == 1
        )
...
class WomenCollege(College):
    ...
    @classmethod
    def axiom(cls, candidate: AnonymousClass) -> Tuple[ConditionType, ...]:
        super_axiom, candidate_var = get_super_axiom_and_candidate_var(WomenCollege, cls, candidate)
...
OWL2BenchThing.has_work = HasWork(OWL2BenchThing, 'has_work')
...
OWL2BenchThing.advises = Advises(OWL2BenchThing, 'advises')
...
Person.has_same_home_town_with = HasSameHomeTownWith(Person, 'has_same_home_town_with')
...
Person.is_advisor_of = IsAdvisorOf(Person, 'is_advisor_of')
